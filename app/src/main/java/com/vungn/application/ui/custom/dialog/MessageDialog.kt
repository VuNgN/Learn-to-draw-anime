package com.vungn.application.ui.custom.dialog
...
import com.vungn.application.databinding.DialogMessageBinding
...
class MessageDialog : ConstraintLayout {
    ...
    private fun init(attrs: AttributeSet? = null) {
        binding = DialogMessageBinding.inflate(LayoutInflater.from(context), this, true)
